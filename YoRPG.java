...
public class YoRPG
{
	...
	try {
	    nameofclass = in.readLine();
	}
	catch (IOException e) { }

	//instantiate the player's character
	if (nameofclass.equals("1")){
	    System.out.println(Warrior.about());
	    pat = new Warrior(name);}
	else if (nameofclass.equals("2")){
	    System.out.println(Mage.about());
	    pat = new Mage(name);}
	else if (nameofclass.equals("3")){
	    System.out.println(Tank.about());
	    pat = new Tank(name);}
	else if (nameofclass.equals("4")){
	    System.out.println(Rogue.about());
	    pat = new Rogue(name);}
	else if (nameofclass.equals("5")){
	    System.out.println(Archer.about());
	    pat = new Archer(name);}
	else{
	    System.out.println("This class is not an option, class set to Warrior by default");
	    pat = new Warrior(name);}
